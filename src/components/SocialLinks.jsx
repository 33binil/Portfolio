...
import {
    ...
    Youtube,
    ExternalLink,
    MessageCircle, // Icon for WhatsApp
    Mail // Icon for Gmail
} from "lucide-react";
...
const socialLinks = [
    {
        ...
        subText: "on LinkedIn",
        icon: Linkedin,
        url: "www.linkedin.com/in/binil-b-a1a118303",
        color: "#0A66C2",
    ...
    },
    {
        ...
        url: "https://wa.me/917902931503", // Replace with your WhatsApp link
        color: "#25D366",
    ...
    },
    {
        ...
        url: "mailto:33binilb@gmail.com", // Replace with your Gmail address
        color: "#D44638",
...
const SocialLinks = () => {
    ...
    const [instagram, youtube, whatsapp, gmail] = otherLinks;
             ...
             hover:border-white/20 transition-all duration-500"
               ...
               transform group-hover:translate-x-0 -translate-x-1"
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    {[instagram, youtube, whatsapp, gmail].map((link) => (
                        <a
                            key={link.name}
                            href={link.url}
                            target="_blank"
